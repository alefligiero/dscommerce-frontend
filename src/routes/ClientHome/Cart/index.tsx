            ...
            {cart.items.map((item) => (
              ...
              >
                <div className="dsc-cart-item-left">
                  ...
                  <div className="dsc-card-item-description">
                    <h3>{item.name}</h3>
                    <div className="dsc-cart-item-quantity-container">
                      <div onClick={() => handleDecreaseItem(item.productId)} className="dsc-card-item-quantity-btn">-</div>
                      <p>{item.quantity}</p>
                      <div onClick={() => handleIncreaseItem(item.productId)} className="dsc-card-item-quantity-btn">+</div>
                    </div>
                  </div>
                </div>
